...
<!-- 			                    </div> -->
			                    ...
			                    <div class="form-group">
			                      <label>전화번호</label>
			                      <input type="tel" class="form-control" id="phone" name="phone" readonly style="background : white;">
			                    </div>
			                    
			                    <div class="form-group">
			                      <label>생년월일</label>
			                      <input type="text" class="form-control" id="birthDay" name="birthDay" readonly style="background : white;">
			                    </div>
